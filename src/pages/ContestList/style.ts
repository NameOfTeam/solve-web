...
export const ContestItem = styled(ThemedBox)`
  width: 100%;
  height: 5rem;
  cursor: pointer;
  border-radius: 1rem;
...
`;
export const ContestTitle = styled(ThemedText)`
  flex: 9;
  font-size: 1.4rem;
`;
export const ContestStateWrap = styled.div`
  flex: 1;
  height: 100%;
  display: flex;
  align-items: center;
...
export const DayLeft = styled.div<{background: string}>`
  height: 2rem;
  border-radius: 0.5rem;
  display: flex;
  align-items: center;
